...
public class TareErrorGUI extends JFrame {
	
	private JButton okButton = new JButton("ΕΝΤΑΞΕΙ");
	private JFrame powerFrame=  new JFrame("ΠΡΟΣΟΧΗ");
	private JPanel panel = new JPanel();
	private JLabel message = new JLabel("Προσοχή, απόβαρο ίδιο με μεικτό βάρος ! ");
	private JDialog dialog = new JDialog(powerFrame,"ΠΡΟΣΟΧΗ",ModalityType.APPLICATION_MODAL);
