...
public class NoPerSelectedGUI extends JFrame {
	
	private JButton okButton = new JButton("ΕΝΤΑΞΕΙ");
	private JFrame powerFrame=  new JFrame("Λανθασμένη εισαγωγή");
	private JPanel panel = new JPanel();
	private JLabel message = new JLabel("Δεν έχετε επιλέξει ποσοστό ! ");
	private JDialog dialog = new JDialog(powerFrame,"Λανθασμένη εισαγωγή",ModalityType.APPLICATION_MODAL);

	public NoPerSelectedGUI() {
